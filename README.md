...
```
.
├── public/                      # Static html, assets, and presets
│   ├── demos/
│   └── main/
├── src/                         # Core source code and utilities
├── src-demos/                   # Source code for technical demos:
│                                # visual testing and tweaking
├── src-main/                    # Source for main visuals,
│                                # interactive animations, and visual
│                                # experiences
├── scripts/                     # Development scripts
├── tests/                       # Manual tests for accuracy/
│                                # statistics
├── LICENSE                      # MIT License for all source code
├── LICENSE-CC-BY-4.0.txt        # CC BY 4.0 license for demo visuals
│                                # and presets
├── LICENSE-CC-BY-NC-SA-4.0.txt  # CC BY-NC-SA 4.0 license for main
│                                # visuals and presets
...
- **Source code and HTML**  
  - Files in `src/`, `src-demos/`, `src-main/`, `scripts/`, `tests/`, and all HTML files in `public/`
...
- **Technical demo content:**
  - Visuals, interactive animations, and visual experiences generated by the applications built from the source 
    code in `public/demos/` and `src-demos/`.
...
- **Main content:**
  - Visuals, interactive animations, and visual experiences generated by the applications built from the source 
    code in `public/main/` and `src-main/`
