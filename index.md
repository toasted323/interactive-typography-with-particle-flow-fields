...
├── src-demos/                   # Source code for technical demonstrations for visual testing and tweaking
├── src-main/                    # Source code for the main visuals, interactive animations, and visual experiences
├── scripts/                     # Development scripts
├── tests/                       # Manual tests for accuracy/statistics
...
- **Source code and HTML**  
  (`src/`, `src-demos/`, `src-main/`, `scripts/`, `tests/`, and HTML files in `public/`):  
